...
export default function Header(){
    ...
    return (
        <header id={styles.header}>
                ...
                <Link href="/">
                    <a alt="Ir para Home">
                        <img src="images/logo.svg" id={styles.logo} alt="Logo" />
                    </a>
                </Link>
                ...
                <button className={open ? styles.mostrar : ''} type="button" id={ styles['btn-close']} data-close="menu" onClick={handleClick} >
